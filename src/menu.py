...
class Menu:
    def __init__(self):
        ...
        try:
            self.bg = pygame.image.load(resource_path("assets/images/background/MenuBg.png")).convert()
    ...
    def run(self):
        ...
        try:
            ...
            sound_select = pygame.mixer.Sound(resource_path("assets/sounds/selectenter.flac"))
        except Exception as e:
